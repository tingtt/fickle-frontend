...
export const ThemeOverView = ({
  ...
  return (
    <div
      className='border-base-content/20 hover:border-base-content/40 outline-base-content overflow-hidden rounded-lg border outline-2 outline-offset-2 outline'
